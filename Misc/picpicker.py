...
class ImageSelector:
    def __init__(self, master, gridScaleX=3, gridScaleY=3):
        ...
        self.progress_frame.grid(row=1, column=0, columnspan=3, sticky='ew')
        ...
        self.background_frame.grid_rowconfigure(2, weight=1)
        ...
        self.controls_frame.grid(row=3, column=1, sticky='ew')
...
def main():
    ...
    style.configure('Highlight.Image.TButton', borderwidth=3, relief='solid', bordercolor='red', background='#555555')  # Red border for selected images
